...
@section('content')
    ...
    <div class="container mt-5">
        <div class="row text-center">
            <div class="col-12">
                <h1 class="hi-fontSize-29 indigo-text dinar-title">انتقادات و شکایات خود را برای ما بفرستید</h1>
            </div>
        </div>
                ...
                <div class="m-card hi-shadow-2 grey lighten-4 px-5">
                    <form>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-auto">
                                <button type="submit" class="m-btn-round btn-round-filled-theme mt-4 py-3 hi-shadow-1">ارسال پیغام</button>
                            </div>
                        </div>
                    </form>
                </div>
